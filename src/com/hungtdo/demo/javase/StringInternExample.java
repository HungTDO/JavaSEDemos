...
public class StringInternExample {
	...
	public static void main(String[] args) {
		...
		printResults("(1)", "aString", aString, "aConcatentatedString",
				aConcatentatedString);
		...
		// to equals(...), but not ==
		printResults("(2)", "aString", aString, "aRuntimeString",
				aRuntimeString);
		...
		// object.
		printResults("(3)", "aString", aString, "anInternedString",
				anInternedString);
		...
		// around a literal.
		printResults("(4)", "aString", aString, "anExplicitString",
				anExplicitString);
		...
		if (args.length > 0) {
			...
			printResults("(6)", "aString", aString, "firstArgInterned",
					firstArgInterned);
		}
	}
	 ...
	 */
	private static void printResults(String tag, String s1Name, String s1,
			String s2Name, String s2) {
		System.out.println(tag);
		System.out
				.println("  " + s1Name + " == " + s2Name + " : " + (s1 == s2));
		System.out.println("  " + s1Name + ".equals(" + s2Name + ") : "
				+ s1.equals(s2));
		System.out.println();
	}
